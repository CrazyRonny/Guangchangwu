...
BOOL CBase64::StringToWString(const std::string &str,std::wstring &wstr)
{    
...
BOOL CBase64::WStringToString(const std::wstring &wstr,std::string &str)
{    
...
bool CBase64::IsFileExist(const char* file_name)
{	
	fstream fs;
